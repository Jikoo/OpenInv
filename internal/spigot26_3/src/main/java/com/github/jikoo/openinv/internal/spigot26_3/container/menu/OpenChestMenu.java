...
import com.github.jikoo.openinv.internal.spigot26_3.container.bukkit.OpenDummyInventory;
...
public abstract class OpenChestMenu<T extends Container & ISpecialInventory & InternalOwned<ServerPlayer>>
  ...
  @Override
  public void clicked(int i, int j, @NotNull ContainerInput clickType, @NotNull Player player) {
    if (viewOnly) {
